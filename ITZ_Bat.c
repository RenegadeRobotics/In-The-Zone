...
#pragma config(Motor,  port2,           rightBack,     tmotorVex393_MC29, PIDControl, reversed, encoderPort, dgtl5)
#pragma config(Motor,  port3,           rightFront,    tmotorVex393_MC29, PIDControl, reversed, encoderPort, dgtl5)
...
#pragma config(Motor,  port8,           leftBack,      tmotorVex393_MC29, PIDControl, encoderPort, dgtl2)
#pragma config(Motor,  port9,           leftFront,     tmotorVex393_MC29, PIDControl, encoderPort, dgtl2)
...
task LCDControl()
{
	...
	while(true){
		if(auton==-1){
			...
			displayLCDNumber(0, 0,SensorValue[SonicSensor], -1);
