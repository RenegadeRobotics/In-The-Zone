...
#pragma config(Motor,  port2,           rightBack,     tmotorVex393_MC29, openLoop, encoderPort, dgtl5)
#pragma config(Motor,  port3,           rightFront,    tmotorVex393_MC29, openLoop, encoderPort, dgtl5)
...
#pragma config(Motor,  port6,           topLift,       tmotorVex393_MC29, openLoop)
