...
#pragma config(Motor,  port2,           rightBack,     tmotorServoContinuousRotation, PIDControl, reversed, driveRight, encoderPort, dgtl2)
#pragma config(Motor,  port3,           rightFront,    tmotorServoContinuousRotation, PIDControl, reversed, driveRight, encoderPort, dgtl2)
...
#pragma config(Motor,  port8,           leftBack,      tmotorServoContinuousRotation, PIDControl, driveLeft, encoderPort, dgtl4)
#pragma config(Motor,  port9,           leftFront,     tmotorServoContinuousRotation, PIDControl, driveLeft, encoderPort, dgtl4)
...
void LiftUsingPOT (int power, int topPOTlimit, int bottomPOTlimit, string *direction, int killSwitch){
	...
	if (*direction == "up") {
		...
		while (topPOTvalue <= topPOTlimit && bottomPOTvalue <= bottomPOTlimit&& time1[T1] < killSwitch){
...
task autonomous()
{
	...
	LiftUsingPOT (80, 1500, 1400, "up",6000);
	distance = SensorValue[SonicSensor];
	...
	//open claw
	LiftUsingPOT(-40, 1400, 1300, "down", 4000);
	SetMotor(claw, 80);
	wait1Msec(500);
	SetMotor(claw, 0);
	wait1Msec(500);
