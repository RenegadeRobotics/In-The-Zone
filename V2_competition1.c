...
#pragma config(Motor,  port2,           rightBack,     tmotorServoContinuousRotation, openLoop, driveLeft)
#pragma config(Motor,  port3,           rightFront,    tmotorServoContinuousRotation, openLoop, driveLeft, encoderPort, None)
...
#pragma config(Motor,  port8,           leftBack,      tmotorServoContinuousRotation, openLoop, driveRight)
#pragma config(Motor,  port9,           leftFront,     tmotorServoContinuousRotation, openLoop, driveRight)
