...
#pragma config(Sensor, dgtl3,  frontLeftEnc,   sensorQuadEncoder)
#pragma config(Sensor, dgtl5,  frontRightEnc,  sensorQuadEncoder)
#pragma config(Motor,  port2,           rightBack,     tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port3,           rightFront,    tmotorServoContinuousRotation, openLoop, reversed, encoderPort, None)
